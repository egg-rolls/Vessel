...
| 回路 | 触发条件 | 方向 | 动作 |
|------|---------|------|------|
| **架构合规退回** | 阶段 2 预检发现方案违反 AGENTS.md 红线/ADR/Core 冻结 | 架构师 → 需求分析师 | 退回 PRD，标注违规项。需求分析师修订 PRD 后重新进入阶段 2 |
...
**反面**：架构师发现 PRD 违规但觉得"改一下就行"自己脑补修正。后果：修正没经过需求分析师确认 → 可能和 PRD 原始意图冲突 → 返工。
