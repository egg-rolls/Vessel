...
2. 判断角色：用户的请求属于哪种场景？
3. 读角色文档：
   - 需求分析/写PRD → [docs/guides/REQ-TODO.md](docs/guides/REQ-TODO.md)
   - 架构设计/写SPEC → [docs/guides/ARCH-TODO.md](docs/guides/ARCH-TODO.md)
   - 写/改代码 → [docs/guides/DEV-TODO.md](docs/guides/DEV-TODO.md)
...
| 你的任务 | 第一步 |
|---------|--------|
| 需求分析 / 写 PRD | 先读 [`docs/guides/REQ-TODO.md`](docs/guides/REQ-TODO.md) |
| 架构设计 / 写 SPEC | 先读 [`docs/guides/ARCH-TODO.md`](docs/guides/ARCH-TODO.md) |
| 写/改代码 | 先读 [`docs/guides/DEV-TODO.md`](docs/guides/DEV-TODO.md) |
