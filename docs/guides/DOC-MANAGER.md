...
> **修改任何文档前，必须先读完本文件列出的所有文档。按顺序读，读完一项自检一项。**
...
### 3. CLAUDE.md §2 文档加载策略

理解永久文档和临时文档的分层、宪法级文档、按需加载表。

**自检**：你要改的文件在 specs/guides/api 还是 dev/？永久文档的禁用词有哪些？
